                ...
                <View style={styles.productsContainer}>
                    {
                        products.map(product => {
                            return (
                                <Pressable
                                    onPress={() => navigation.navigate('Detail')} style={styles.product}>
            ...
            <View>
                <View style={styles.searchContainer}>
                    <View style={styles.searchTextContainer}>
                        <Image style={styles.imageSearchInputContainer} source={require('../../../../assets/images/searchBlue.png')} />
                        <TextInput style={styles.textInput} placeholder={'Pizza'} />
                    </View>
                    <Pressable style={styles.searchRightContainer}>
                        <Image style={styles.imageInputContainer} source={require('../../../../assets/images/pheu.png')} />
                    </Pressable>
                </View>
                <View>
